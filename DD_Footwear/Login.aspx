<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="DD_Footwear.Login" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="Txtemail" runat="server" ErrorMessage="Username Required"></asp:RequiredFieldValidator>
        ...
        <br />
        <br />
        <asp:Button ID="Button1" runat="server" Text="Log In" BackColor="DarkGreen" OnClick="Button1_Click"  />
